...
from helpers import euclidean_TV_loss, euclidean_TV_SSIM_loss
...
def training(epochs, train_dataset, val_dataset, model, device='cuda'):
    ...
    for epoch in tqdm.tqdm(range(epochs)):
        ...
        for noisy, clean in train_dataset:
            ...
            loss = euclidean_TV_SSIM_loss(y_pred=output, y_ground=clean)
            loss.backward()
            optimizer.step()
        ...
        if (epoch+1)%2 == 0:
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), 'SAR/models/best_denoising_model_Inception_Full.pth')
...
if __name__ == "__main__":
    ...
    torch.save(model_idcnn.state_dict(), "SAR/models/idcnn_inception_full.pth")
